...
if choice == "d":
    ...
    print ("Hello Alice ...")
    testMac = int(input("Enter Bob's MAC : "))
PN = [[0], [0], [0]]
CN = [[0], [0], [0]]
...
if choice == "e":
    ...
    print("Translation Text plus MAC is :" + cipherText + str(translationMac))
if choice == "d":
    if (testMac == messageMac):
        print("Bob's Message is Authenticated")
        print("Bob's Message is : " + cipherText)
    else:
        print("Bob's MAC should be:" + str(messageMac))
